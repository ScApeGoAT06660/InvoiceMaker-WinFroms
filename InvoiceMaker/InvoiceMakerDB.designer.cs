...
namespace InvoiceMaker
{
    ...
    partial void OnIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_Buyers", Storage="_Traders", ThisKey="Id", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnPESELChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_PrivatePersons", Storage="_Traders", ThisKey="Id", OtherKey="Id", IsForeignKey=true)]
		public Traders Traders
		{
			get
			{
			...
			set
			{
							...
							|| (this._Traders.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Traders.Entity = null;
						previousValue.PrivatePersons = null;
					}
					this._Traders.Entity = value;
					if ((value != null))
					{
						value.PrivatePersons = this;
						this._Id = value.Id;
					}
					else
					{
    ...
    partial void OnSWIFTChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_Sellers", Storage="_Traders", ThisKey="Id", OtherKey="Id", IsForeignKey=true)]
		public Traders Traders
		{
			get
			{
	...
	public partial class Traders : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<PrivatePersons> _PrivatePersons;
    ...
    partial void OnTraderTypeChanged();
		...
		{
			this._Buyers = default(EntityRef<Buyers>);
			this._PrivatePersons = default(EntityRef<PrivatePersons>);
			this._Sellers = default(EntityRef<Sellers>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_Buyers", Storage="_Buyers", ThisKey="Id", OtherKey="Id", IsUnique=true, IsForeignKey=false)]
		public Buyers Buyers
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_PrivatePersons", Storage="_PrivatePersons", ThisKey="Id", OtherKey="Id", IsUnique=true, IsForeignKey=false)]
		public PrivatePersons PrivatePersons
		{
			get
			{
				return this._PrivatePersons.Entity;
			}
			set
			{
				PrivatePersons previousValue = this._PrivatePersons.Entity;
				if (((previousValue != value) 
							|| (this._PrivatePersons.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._PrivatePersons.Entity = null;
						previousValue.Traders = null;
					}
					this._PrivatePersons.Entity = value;
					if ((value != null))
					{
						value.Traders = this;
					}
					this.SendPropertyChanged("PrivatePersons");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Traders_Sellers", Storage="_Sellers", ThisKey="Id", OtherKey="Id", IsUnique=true, IsForeignKey=false)]
		public Sellers Sellers
		{
			get
			{
